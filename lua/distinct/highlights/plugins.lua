...
function M.get_highlights(theme)
    return {
        ...
        TodoFgTODO = { fg = theme.raw.light_green },
        TodoBgTODO = { fg = theme.ui.bg_dark, bg = theme.raw.light_green },
        TodoSignTODO = { fg = theme.raw.light_green, bg = theme.ui.bg_dark },
        ...
        TodoFgPERF = { fg = theme.raw.pink },
        TodoBgPERF = { fg = theme.ui.bg_dark, bg = theme.raw.pink },
        TodoSignPERF = { fg = theme.raw.pink, bg = theme.ui.bg_dark },
